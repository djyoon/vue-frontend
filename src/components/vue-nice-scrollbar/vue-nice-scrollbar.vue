<template>
    <div class="nice-bar" v-bind:class="[ theme==='dark' ? 'theme-dark' : 'theme-light', classes ? ' ' + classes : '']" ref="scrollContainer">
        ...
        <vertical-scrollbar v-if="visibleVert" v-bind:content="{ height: scrollContentHeight }" v-bind:container="{ height: scrollContainerHeight }"
        ...
        <horizontal-scrollbar v-if="visibleHori" v-bind:content="{ width: scrollContentWidth }" v-bind:container="{ width: scrollContainerWidth }"
...
<script>
    ...
    export default {
        ...
        computed: {
            visibleHori: function() {
                return this.ready && (this.display === "both" || this.display === "horizontal")
            },
            visibleVert: function() {
                return this.ready && (this.display === "both" || this.display === "vertical")
            }
        },
        components: {
