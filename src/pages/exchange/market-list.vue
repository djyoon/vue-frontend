<template>
    <div class="state__price">
        <div class="state__price-header clearfix">
            <button class="state__price-tab-btn float-left" v-bind:class="{active: cur_market_base == 'USD'}" v-on:click="changeMarket('USD')">USD</button>
            <button class="state__price-tab-btn float-left" v-bind:class="{active: cur_market_base == 'BTC'}" v-on:click="changeMarket('BTC')">BTC</button>
            <button class="state__price-tab-btn float-left" v-bind:class="{active: cur_market_base == 'ETH'}" v-on:click="changeMarket('ETH')">ETH</button>
            <button class="state__price-tab-btn float-right" v-bind:class="{active: cur_market_base == 'favor'}" v-on:click="changeMarket('favor')">Favorite</button>
        </div>
        <div class="state__price-body">
            <div class="table state__price-table">
                <table>
                    ...
                    <tbody>
                        <tr v-for="(row, index) in market_list[cur_market_base]" :key="row.market_id" :class="{up: row.change_rate > 0, down: row.change_rate < 0}">
